/*
 * File: look2_iu16s16lu32n16tu16_binlcse.c
 *
...
uint16_T look2_iu16s16lu32n16tu16_binlcse(uint16_T u0, int16_T u1, const
  uint16_T bp0[], const int16_T bp1[], const uint16_T table[], const uint32_T
