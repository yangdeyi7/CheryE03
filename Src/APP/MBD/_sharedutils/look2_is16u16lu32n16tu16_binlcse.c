/*
 * File: look2_is16u16lu32n16tu16_binlcse.c
 *
...
uint16_T look2_is16u16lu32n16tu16_binlcse(int16_T u0, uint16_T u1, const int16_T
  bp0[], const uint16_T bp1[], const uint16_T table[], const uint32_T maxIndex[],
  uint32_T stride)
{
  uint16_T y;
  uint32_T frac;
