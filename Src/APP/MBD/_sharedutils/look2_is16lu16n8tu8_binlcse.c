/*
 * File: look2_is16lu16n8tu8_binlcse.c
 *
...
uint8_T look2_is16lu16n8tu8_binlcse(int16_T u0, int16_T u1, const int16_T bp0[],
  const int16_T bp1[], const uint8_T table[], const uint32_T maxIndex[],
  uint32_T stride)
{
  uint8_T y;
  uint16_T frac;
  ...
  if (yR_0d0 >= table[bpIdx]) {
    yL_1d = (uint8_T)(((uint32_T)((uint8_T)((((uint32_T)((uint8_T)(((uint32_T)
      yR_0d0) - ((uint32_T)table[bpIdx])))) * ((uint32_T)fractions[0U])) >> 8)))
  ...
  if (yR_0d0 >= yL_1d) {
    y = (uint8_T)(((uint32_T)((uint8_T)((((uint32_T)((uint8_T)(((uint32_T)yR_0d0)
      - ((uint32_T)yL_1d)))) * ((uint32_T)frac)) >> 8))) + ((uint32_T)yL_1d));
  } else {
    y = (uint8_T)(((uint32_T)yL_1d) - ((uint32_T)((uint8_T)((((uint32_T)
      ((uint8_T)(((uint32_T)yL_1d) - ((uint32_T)yR_0d0)))) * ((uint32_T)frac)) >>
      8))));
  }
