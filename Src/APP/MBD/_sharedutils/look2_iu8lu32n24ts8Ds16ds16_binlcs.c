/*
 * File: look2_iu8lu32n24ts8Ds16ds16_binlcs.c
 *
...
int8_T look2_iu8lu32n24ts8Ds16ds16_binlcs(uint8_T u0, uint8_T u1, const uint8_T
  bp0[], const uint8_T bp1[], const int8_T table[], const uint32_T maxIndex[],
  uint32_T stride)
{
  uint32_T frac;
  ...
  if (u1 <= bp1[0U]) {
    ...
    frac = (((uint32_T)((uint8_T)(((uint32_T)u1) - ((uint32_T)bp1[iLeft])))) <<
            24) / ((uint32_T)((uint8_T)(((uint32_T)bp1[iLeft + 1U]) - ((uint32_T)
      bp1[iLeft]))));
  } else {
  ...
  return (int8_T)(((int8_T)asr_s32(((int32_T)((int16_T)((int32_T)(((int32_T)
    ...
    table[bpIdx + 1U]) - ((int32_T)table[bpIdx]))))) * ((int32_T)fractions[0U]),
    24U)) + table[bpIdx]))) - ((int32_T)yL_1d))))) * ((int32_T)frac), 24U)) +
                  yL_1d);
}
