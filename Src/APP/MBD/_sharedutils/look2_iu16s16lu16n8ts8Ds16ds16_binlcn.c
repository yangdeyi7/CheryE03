/*
 * File: look2_iu16s16lu16n8ts8Ds16ds16_binlcn.c
 *
...
int8_T look2_iu16s16lu16n8ts8Ds16ds16_binlcn(uint16_T u0, int16_T u1, const
  uint16_T bp0[], const int16_T bp1[], const int8_T table[], const uint32_T
  maxIndex[], uint32_T stride)
{
  ...
  tmp = ((int32_T)((int16_T)((int32_T)(((int32_T)table[bpIdx + 1U]) - ((int32_T)
             table[bpIdx]))))) * ((int32_T)fractions[0U]);
  yL_1d = (int8_T)(((int8_T)(((int32_T)(((tmp & 128) != 0) ? 1 : 0)) + asr_s32
    (tmp, 8U))) + table[bpIdx]);
  bpIdx += stride;
  tmp = ((int32_T)((int16_T)((int32_T)(((int32_T)table[bpIdx + 1U]) - ((int32_T)
             table[bpIdx]))))) * ((int32_T)fractions[0U]);
  tmp = ((int32_T)((int16_T)((int32_T)(((int32_T)((int8_T)(((int8_T)(((int32_T)
    (((tmp & 128) != 0) ? 1 : 0)) + asr_s32(tmp, 8U))) + table[bpIdx]))) -
            ((int32_T)yL_1d))))) * ((int32_T)frac);
  return (int8_T)(((int8_T)(((int32_T)(((tmp & 128) != 0) ? 1 : 0)) + asr_s32
    (tmp, 8U))) + yL_1d);
}
